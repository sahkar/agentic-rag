...
if __name__ == "__main__":
    ...
    if "graph_temp_dir" not in st.session_state:
        st.session_state["graph_temp_dir"] = tempfile.mkdtemp()
        
    if files:
        temp_dir = st.session_state["graph_temp_dir"]
    ...
    if "graph" not in st.session_state:
        ...
        rag:GraphRAG = st.session_state["graph"]
    
    rag = st.session_state["graph"]
    if files: 
        rag.load_documents(st.session_state['graph_temp_dir'])
